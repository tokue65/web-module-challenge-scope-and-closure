...
/*Task 1: counterMaker()
  ...
  the variable is defined within function counterMaker in count1. The variable let, is block scoped, so count can only be access inside of function counterMaker. In counter 2, the variable can be accessed anywhere because it is defined globally. 
  
  2. Which of the two uses a closure? How can you tell?
  
  counter 1, return count is found within the function. 

  3. In what scenario would the counter1 code be preferable? In what scenario would 
     counter2 be better?  

     counter 1 - when you have data that you want to iterate within the counterMaker function.
     counter 2 - when you want to access count variable both in and out of the function. This one is an inverse approach to counter1.
*/
...
function scoreboard(getInningScoreCB, inningCB, inningsNum) {
 ...
 for (let i = 0; i < inningsNum; i++){
  const currentInning = getInningScoreCB(inningCB); //current inning score
